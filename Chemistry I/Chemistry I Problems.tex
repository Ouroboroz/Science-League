...
\begin{document}
	...
	\begin{enumerate}
		...
		\item[23)]
		Okay I have seriously ran out of creativeness. No jokes anymore. Just facts. For ionization energy, if one were to go down a column, what woudl happen?
		\begin{enumerate}
			\item 
			\inlineitem 
			\inlineitem 
		...
		\item[24)]
		Suppose that Kevin has a cup of ice at $-3^oC$. He wants to heat it up to $25^oC$. How much energy would Kevin have to put into the ice in order to raise it up to the desired temperature?
		\begin{enumerate}
			\item 
			\inlineitem 
			\inlineitem 
